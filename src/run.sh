...
if [ -z "${PHP_EXTENSION_XDEBUG_REMOTE_HOST}" ]; then
  PHP_EXTENSION_XDEBUG_REMOTE_HOST="$(/sbin/ip route | awk '/default/ { print $3 }')"
fi

export FACTER_PHP_EXTENSION_XDEBUG_REMOTE_HOST"${PHP_EXTENSION_XDEBUG_REMOTE_HOST}"
