class phpfarm::php {
  ...
  file { '/phpfarm/src/custom-options-5.5.17-dev.sh':
    ...
    source => 'puppet:///modules/phpfarm/phpfarm/src/custom-options-5.5.17-dev.sh',
    mode => 755,
  ...
  file { '/phpfarm/inst/php-5.5.17-dev/etc/php-fpm.conf':
    ...
    source => 'puppet:///modules/phpfarm/phpfarm/inst/php-5.5.17-dev/etc/php-fpm.conf',
    mode => 644,
    require => Exec['/phpfarm/src/compile.sh 5.5.17-dev']
  }
  ...
  file { '/phpfarm/inst/php-5.5.17-dev/lib/php.ini':
    ...
    source => 'puppet:///modules/phpfarm/phpfarm/inst/php-5.5.17-dev/lib/php.ini',
    mode => 644,
    require => Exec['/phpfarm/src/compile.sh 5.5.17-dev']
  }
